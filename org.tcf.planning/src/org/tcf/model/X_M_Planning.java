...
/** Generated Model for M_Planning
 *  @author iDempiere (generated) 
 *  @version Release 9 - $Id$ */
@org.adempiere.base.Model(table="M_Planning")
public class X_M_Planning extends PO implements I_M_Planning, I_Persistent 
{
...
// 0
    ...
    /** Standard Constructor */
    public X_M_Planning (Properties ctx, int M_Planning_ID, String trxName, String ... virtualColumns)
    {
...
// 0
    ...
    /** Load Constructor */
    public X_M_Planning (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_M_Planning[")
	...
	*/
	...
	{
		set_ValueNoCheck (COLUMNNAME_DateFinishSchedule, DateFinishSchedule);
	}
	...
	*/
	...
	/** Set M_Planning_UU.
		@param M_Planning_UU M_Planning_UU
	*/
	public void setM_Planning_UU (String M_Planning_UU)
	{
		set_Value (COLUMNNAME_M_Planning_UU, M_Planning_UU);
	}

	/** Get M_Planning_UU.
		@return M_Planning_UU	  */
	public String getM_Planning_UU()
	{
		return (String)get_Value(COLUMNNAME_M_Planning_UU);
	}
	...
	*/
	...
	/** Set Remain Qty Production.
		@param RemainQtyProduction Remain Qty Production
	*/
	public void setRemainQtyProduction (BigDecimal RemainQtyProduction)
	{
		throw new IllegalArgumentException ("RemainQtyProduction is virtual column");	}

	/** Get Remain Qty Production.
		@return Remain Qty Production
	  */
	public BigDecimal getRemainQtyProduction()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_RemainQtyProduction);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	*/
	...
	/** Shift Malam = 10000006 */
	public static final String TCF_SHIFT_ShiftMalam = "10000006";
	/** Shift Pagi = 10000007 */
	public static final String TCF_SHIFT_ShiftPagi = "10000007";
	/** Shift Sore = 10000008 */
	public static final String TCF_SHIFT_ShiftSore = "10000008";
	/** Set TCF_Shift.
		@param TCF_Shift TCF_Shift
	*/
	public void setTCF_Shift (String TCF_Shift)
	{

		set_Value (COLUMNNAME_TCF_Shift, TCF_Shift);
	}

	/** Get TCF_Shift.
		@return TCF_Shift	  */
	public String getTCF_Shift()
	{
		return (String)get_Value(COLUMNNAME_TCF_Shift);
	}
