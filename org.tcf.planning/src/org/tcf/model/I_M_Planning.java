...
/** Generated Interface for M_Planning
 *  @author iDempiere (generated) 
 *  @version Release 9
 */
@SuppressWarnings("all")
public interface I_M_Planning 
{

    /** TableName=M_Planning */
    public static final String Table_Name = "M_Planning";
    ...
    /** Column name M_Planning_ID */
    public static final String COLUMNNAME_M_Planning_ID = "M_Planning_ID";
    ...
    /** Column name M_Planning_UU */
    public static final String COLUMNNAME_M_Planning_UU = "M_Planning_UU";
 ...
 Formula
    ...
    /** Column name ProductionPlanQty */
    public static final String COLUMNNAME_ProductionPlanQty = "ProductionPlanQty";
    ...
    /** Column name RemainQtyProduction */
    public static final String COLUMNNAME_RemainQtyProduction = "RemainQtyProduction";

	/** Set Remain Qty Production.
	  * Remain Qty Production
	  */
    ...
    /** Column name TCF_Shift */
    public static final String COLUMNNAME_TCF_Shift = "TCF_Shift";
