...
protected boolean beforeSave(boolean newRecord) 
{
	...
	if (getM_Planning_ID() > 0) 
	{
		...
		if ( planningParent.getM_Product_ID() == getM_Product_ID() && planningParent.getProductionQty().signum() == getMovementQty().signum())
	...
	else 
	{
		...
		MPlanning prod = new MPlanning(getCtx(), plan.getM_Planning_ID(), get_TrxName());
